...
The gap is breadth and depth around professional testing operations: intercept control, advanced filtering, sitemap, Automate-style fuzzing, findings, reporting, plugin/workflow extensibility, and release polish.
...
| Reports | AI report notes only | Report builder, Markdown/HTML export, evidence appendices, retest status |
