...
import { CircleHelp, GitBranch, Pin, Plus } from "lucide-react";
import type {
...
} from "./agentMissionGraphModel";
import { MissionNodeGlyph } from "./MissionNodeGlyph";
                ...
                return (
                  ...
                  >
                    <span className="flex items-center gap-1 rd-label-sm text-signal">
                      <MissionNodeGlyph node={node} /> {ENTITY_LABELS[node.entity]}
                    </span>
