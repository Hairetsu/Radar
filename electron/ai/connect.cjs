...
function resolvePreset(presetId, savedApiKey = "") {
...
async function probeSettings(settings) {
...
function applyConnectPreset(presetId, savedApiKey) {
...
module.exports = { PRESETS, applyConnectPreset, probeSettings, resolvePreset };
